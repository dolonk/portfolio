...
import 'package:portfolio/features/admin_panel/projects/all_projects/widgets/project_data_table.dart';
import 'package:portfolio/features/admin_panel/projects/all_projects/widgets/project_filters.dart';
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.search_off_rounded, size: 80, color: DColors.textSecondary.withAlpha((255 * 0.5).round())),
            SizedBox(height: s.paddingLg),
            Text(
              'No Projects Found',
              style: context.fonts.titleLarge.rajdhani(fontWeight: FontWeight.bold, color: DColors.textPrimary),
