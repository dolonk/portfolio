                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text(widget.reviews.name, style: fonts.bodyLarge, maxLines: 1, overflow: TextOverflow.ellipsis),
                        SizedBox(height: 2),
                        Text(
                          widget.reviews.role,
                  ...
                  AnimatedOpacity(
                    ...
                    child: ImageIcon(AssetImage('assets/home/icon/background_icon.png'), size: 40, color: Colors.red),
                  ),
                ],
              ),
            ],
