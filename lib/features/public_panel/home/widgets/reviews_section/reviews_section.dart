...
import 'package:portfolio/features/public_panel/home/widgets/reviews_section/widgets/reviews_card.dart';
...
class ReviewsSection extends StatelessWidget {
  ...
  Widget _buildDesktopLayout(BuildContext context) {
    ...
    return Column(
      children: [
        ...
        SizedBox(height: context.sizes.spaceBtwSections * 2),
      ],
    );
  }
  ...
  Widget _buildReviewsCards(BuildContext context, {required bool isMobile}) {
    final s = context.sizes;
    final reviews = ReviewsModel.getReviewsData();
