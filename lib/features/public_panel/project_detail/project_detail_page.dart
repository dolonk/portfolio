...
import '../services/widgets/cta_section/cta_section.dart';
...
import 'package:portfolio/features/public_panel/project_detail/widgets/tech_stack/tech_stack_section.dart';
import 'package:portfolio/features/public_panel/project_detail/widgets/related_projects/related_projects_section.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return BaseScreen(
      ...
      child: DStateBuilder<Project>(
        ...
        onError: (message) => ErrorState(message: message, onRetry: () => vm.fetchProjectById(widget.projectId)),
                ...
                child: Center(
                  child: Column(
                    children: [
                      ...
                      if (project.solutionSteps.isNotEmpty) ...[
                        SolutionSection(project: project),
                        SizedBox(height: s.spaceBtwSections),
                      ],

                      // Tech Stack Used
                      if (project.techStackExtended.isNotEmpty) ...[
